...
<svelte:head>
    <title>Phoenix | Privacy Policy</title>
</svelte:head>
...
<section id="" class="section-a">
	<div class="section-wrapper flex-col">
		...
		<div id="privacy-policy">
			<p>
				At <span class="phoenix-accent">Phoenix</span>, accessible from www.phoenixblocker.com, one
				of our main priorities is the privacy of our visitors. This Privacy Policy document contains
				types of information that is collected and recorded by phoenixblocker.com and how we use it.
			</p>
			...
			<p>
				...
				phoenixblocker.com. This policy is not applicable to any information collected offline or
			...
			<p>
				phoenixblocker.com follows a standard procedure of using log files. These files log visitors
			...
			<p>
				Like any other website, phoenixblocker.com uses "cookies". These cookies are used to store
			...
			<p>
				...
				phoenixblocker.com, which are sent directly to users' browser. They automatically receive
			...
			<p>
				Note that phoenixblocker.com has no access to or control over these cookies that are used by
			...
			<p>
				phoenixblocker.com's Privacy Policy does not apply to other advertisers or websites. Thus,
			...
			<p>
				phoenixblocker.com does not knowingly collect any Personal Identifiable Information from
			...
			<p class="text-center">
				...
				contact us at
				<a class="link-underlined" href="mailto:support@phoenixblocker.com"
